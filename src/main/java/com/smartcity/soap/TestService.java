 ...
 * 
 */
@WebServiceClient(name = "testService", targetNamespace = "http://localhost/test", wsdlLocation = "file:/home/lpotages/Cours/Projet AL/SmartRescue/src/main/resources/newService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName TESTSERVICE_QNAME = new QName("http://localhost/test", "testService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/home/lpotages/Cours/Projet AL/SmartRescue/src/main/resources/newService.wsdl");
    ...
    public TestServiceSoap getTestServiceSoap() {
        return super.getPort(new QName("http://localhost/test", "testServiceSoap"), TestServiceSoap.class);
    }
     ...
     */
    @WebEndpoint(name = "testServiceSoap")
    public TestServiceSoap getTestServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://localhost/test", "testServiceSoap"), TestServiceSoap.class, features);
    }
